...
export default function UserPhotos() {
    ...
    const fetchData = async () => {
      const response = await fetch(`http://13.48.143.44/api/photo/account/${username}/${year}`, {
          headers: {
    ...
    const handleUpload = async () => {
        ...
        for(var i = 0; i < files.length; i++) {
            ...
            var response = await fetch(`http://13.48.143.44/api/photo/upload/${year}`, {
                method: "POST",
                headers: {
                    "Authorization": "Bearer " + token
                },
    ...
    const handleDelete = async () => {
        ...
        const response = await fetch("http://13.48.143.44/api/photo/delete", {
            method: "DELETE",
            headers: {
